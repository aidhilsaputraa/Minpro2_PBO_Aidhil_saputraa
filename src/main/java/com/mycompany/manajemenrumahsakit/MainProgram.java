...
public class MainProgram implements Operasi_CRUD<PersonAbstract> {
    ...
    // final digunakan di ArrayList untuk memastikan referensi ke daftarPerson tidak dapat diubah.
    private static final ArrayList<PersonAbstract> daftarPerson = new ArrayList<>();

    public static void main(final String[] args) {
        final Scanner scanner = new Scanner(System.in);
        final MainProgram program = new MainProgram(); // variabel lokal yang hanya diinisialisasi sekali
        int pilihan;
    ...
    public void tambahDokter(final Scanner scanner) {
        ...
        final String id = scanner.next();  // final digunakan karena nilai ini tidak akan berubah
    ...
    public void tambahPasien(final Scanner scanner) {
        ...
        final int umur = scanner.nextInt();  // final digunakan karena variabel umur tidak akan berubah setelah diinisialisasi

        final Pasien pasien = new Pasien(id, nama, umur);
        tambah(pasien);
    }

    // Implementasi metode CRUD interface
    @Override
    ...
    public void update(final String id, final PersonAbstract person) {
        // Implementasi ini tidak digunakan dalam kode utama
    }
    ...
    public void update(final Scanner scanner) {
        ...
        for (final PersonAbstract person : daftarPerson) {
            if (person.getId().equals(id)) {
                ...
                person.setNama(namaBaru);  // Menggunakan setter untuk mengubah nama
